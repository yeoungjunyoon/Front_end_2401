    ...
    // 객체의 특수한 형태
    let fruitArrey = ['감', '귤', '밤', '배'];
    console.log(typeof fruitArrey);

    let fruitObject = {0: '감', 1:'귤', 2:'밤', 3:'배'};
    console.log(fruitArrey[0],fruitObject[1]);

    // 객체(object) - 자료구조로서 객체는 파일썬의 딕셔너리, 자바의 맵과 유사함
    // key - value 쌍
    ...
    // 객체에 대한 접근
    console.log(personInfo['name']);            // 이렇게는 사용되지않음
